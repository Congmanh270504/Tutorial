...
//	}
//}
//void getNumberFile(FILE *fi, PS &a)// * Quan trọng: lấy từ trong file
//{
...
//	for (int i = 0; i < n; i++)
//	{
//		getNumberFile(f, a[i]);// số trg file
//	}
//	fclose(f);// đóng file
//}
...
//		b.tu *= a[i].tu;
//		b.mau *= a[i].mau;
//		getEasyFrac(b);// sau moi lan nhan len thi toi gian no di cho de~(khong thi no tran so) 
//	}
...
//{
//	float max = convertFracToFloat(a[0]);
//	int j = 0;
//	for (int i=0; i < n; i++)
//	{
//		if (max < convertFracToFloat(a[i]))
//		{
//			max = convertFracToFloat(a[i]);
//			j = i;
//		}
//	}
